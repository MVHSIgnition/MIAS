  ...
  getCurrentTabUrl(function(url) {
    getTabSource(url, function (source, bias) {
      if (source !== undefined && bias !== undefined) {
        ...
        setTimeout(function() {
          bias = document.createElement('h1').textContent = bias.name;
          description = document.createElement('p').textContent = bias.description;
          factualParagraph = document.createElement('span');
          factualEl = document.createElement('factual');
          div.appendChild(bias);
          div.appendChild(description);
          div.appendChild(factualParagraph);
          div.appendChild(factualEl);
